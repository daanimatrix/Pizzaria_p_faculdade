...
<div class="container-fluid" style="background-image: url('assets/images/fundo_pizza.jpg'); background-size: cover; background-position: top center; height: 100vh; background-color: rgba(0, 0, 0, .1);">

<p class="text-center text-warning mb-3">CARDÁPIO</p>
